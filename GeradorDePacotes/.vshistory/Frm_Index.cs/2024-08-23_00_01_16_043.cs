...
namespace GeradorDePacotes
{
    public partial class Frm_Index : Form
    {
        ...
        public Frm_Index()
        {
            ...
            Pnl_Top.MouseDown += new MouseEventHandler(Pnl_Top_MouseDown);
        }

        private void Frm_Index_Load(object sender, EventArgs e)
        {
            // Defina os limites da maximização para respeitar a área de trabalho sem cobrir a barra de tarefas
