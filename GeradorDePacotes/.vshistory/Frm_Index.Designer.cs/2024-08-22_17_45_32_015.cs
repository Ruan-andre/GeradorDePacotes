namespace GeradorDePacotes
{
    partial class Frm_Index
    {
        ...
        private void InitializeComponent()
        {
            ...
            Btn_GerarPacote = new ReaLTaiizor.Controls.Button();
            ...
            checkBox1.Location = new Point(485, 386);
            ...
            // Btn_GerarPacote
            // 
            Btn_GerarPacote.BackColor = Color.FromArgb(76, 149, 108);
            Btn_GerarPacote.BackgroundImageLayout = ImageLayout.None;
            Btn_GerarPacote.BorderColor = Color.Empty;
            Btn_GerarPacote.EnteredBorderColor = Color.FromArgb(165, 37, 37);
            Btn_GerarPacote.EnteredColor = Color.FromArgb(76, 149, 108);
            Btn_GerarPacote.Font = new Font("Microsoft Sans Serif", 12F);
            Btn_GerarPacote.Image = null;
            Btn_GerarPacote.ImageAlign = ContentAlignment.MiddleLeft;
            Btn_GerarPacote.InactiveColor = Color.FromArgb(32, 34, 37);
            Btn_GerarPacote.Location = new Point(474, 321);
            Btn_GerarPacote.Name = "Btn_GerarPacote";
            Btn_GerarPacote.PressedBorderColor = Color.FromArgb(165, 37, 37);
            Btn_GerarPacote.PressedColor = Color.FromArgb(165, 37, 37);
            Btn_GerarPacote.RightToLeft = RightToLeft.No;
            Btn_GerarPacote.Size = new Size(150, 50);
            Btn_GerarPacote.TabIndex = 5;
            Btn_GerarPacote.Text = "Gerar Pacote";
            Btn_GerarPacote.TextAlignment = StringAlignment.Center;
            // 
            // Frm_Index
            // 
        ...
        private ReaLTaiizor.Controls.Button Btn_GerarPacote;
    }
}